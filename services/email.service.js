...
const forgotPasswordTemplate = (token) => {
  ...
  return {
    subject: 'NotesSaver app (Forgot Password)',
    text: `Seems like you forgot your password for NotesSaver app. if this is true, click on the link below to reset your password \n ${url}`,
    html: `
      <h1>Password Reset</h1>
      <p>Seems like you forgot your password for NotesSaver app. if this is true, click on the link below to reset your password</p>
...
const verifyUserTemplate = (token) => {
  ...
  return {
    subject: 'NotesSaver app (Verify account)',
...
module.exports = {
  sendForgotPasswordEmail: async (email, token) => {
    ...
    const info = await transporter.sendMail({
      from: 'NotesSaver App <support@notessaver.com>',
      to:  email,
